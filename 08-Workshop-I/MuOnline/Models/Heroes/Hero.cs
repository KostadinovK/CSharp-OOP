namespace MuOnline.Models.Heroes
{
    ...
    public abstract class Hero : IHero, IIdentifiable, IProgress
    {
            ...
            int strength, int agility, int stamina, int energy)
        {
            ...
            TotalStaminaPoints = GetTotalStaminaPoints();
            TotalAgilityPoints = GetTotalAgilityPoints();
        ...
        public int TotalAttackPoints
            => GetTotalAttackPoints();


        public int TotalEnergyPoints
            => GetTotalEnergyPoints();
        ...
        public int TotalAgilityPoints
        {
            ...
            private set { this.totalAgilityPoints = value; }
        }
        ...
        public int TotalStaminaPoints
        {
            ...
            private set { this.totalStaminaPoints = value; }
        }

        public int GetTotalAttackPoints()
        {
            return this.Strength + this.Agility * 10 / 100 + this.Energy * 5 / 100 + this.Inventory.Items.Sum(x => x.Strength);
        }

        public int GetTotalEnergyPoints()
        {
            return this.Energy + this.Inventory.Items.Sum(x => x.Energy);
        }
        public int GetTotalAgilityPoints()
        {
            return this.Agility + this.Inventory.Items.Sum(x => x.Agility);
        }

        public int GetTotalStaminaPoints()
        {
