...
namespace P06_Sneaking
{
    class Sneaking
    {
        ...
        static void Main()
        {
            ...
            FillMatrix(ref room, n);
           
            moves = Console.ReadLine().ToCharArray();

            samPosition = GetSamPosition();
        ...
        private static void FillMatrix(ref char[][] matrix, int rows)
        {
        ...
        private static void Move(int moveIndex)
        {
        ...
        private static bool NikoladzeKilled(int[] getEnemy)
        {
